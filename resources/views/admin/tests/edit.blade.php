...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('publised', trans('quickadmin.tests.fields.publised').'', ['class' => 'control-label']) !!}
                    {!! Form::hidden('publised', 0) !!}
                    {!! Form::checkbox('publised', 1, old('publised', old('publised')), []) !!}
                    <p class="help-block"></p>
                    @if($errors->has('publised'))
                        <p class="help-block">
                            {{ $errors->first('publised') }}
                        </p>
                    @endif
                </div>
            </div>
