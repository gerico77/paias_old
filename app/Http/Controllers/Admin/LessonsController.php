...
class LessonsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $lessons = Lesson::whereIn('course_id', Course::ofProfessor()->pluck('id'));
    ...
    public function create()
    {
        ...
        $courses = \App\Course::ofProfessor()->get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
