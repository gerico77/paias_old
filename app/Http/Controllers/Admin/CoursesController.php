...
class CoursesController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request('show_deleted') == 1) {
            ...
            $courses = Course::onlyTrashed()->ofProfessor()->get();
        } else {
            $courses = Course::ofProfessor()->get();
        }
    ...
    public function create()
    {
        ...
        $professors = \App\User::whereHas('role', function ($q) { $q->where('role_id', 2); } )->get()->pluck('name', 'id');
    ...
    public function store(StoreCoursesRequest $request)
    {
        ...
        $professors = \Auth::user()->isAdmin() ? array_filter((array)$request->input('professors')) : [\Auth::user()->id];
        $course->professors()->sync($professors);
    ...
    public function show($id)
    {
        ...
        $professors = \App\User::get()->pluck('name', 'id');
